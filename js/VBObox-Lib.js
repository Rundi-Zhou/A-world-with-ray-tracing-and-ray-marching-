...
function VBObox0() {
    ...
    this.bgnBox = this.vboVerts;
    this.appendBox();
    this.bgnTorus = this.vboVerts;
    this.appendTorus();
...
VBObox0.prototype.draw = function() {
    ...
    mat4.translate(this.mvpMat, this.mvpMat, g_myScene.lamp1.lightPos);
    mat4.scale(this.mvpMat, this.mvpMat, vec3.fromValues(0.2, 0.2, 0.2));

    gl.uniformMatrix4fv(this.u_mvpMatLoc, false, this.mvpMat);
    gl.drawArrays(gl.LINE_STRIP, this.bgnSphere, this.bgnBox - this.bgnSphere);
    ...
    switch(sceneNum) {
        case 0:
            ...
            mat4.rotate(this.mvpMat, this.mvpMat, 0.25*Math.PI, vec3.fromValues(1,1,0));
            ...
            gl.drawArrays(gl.LINE_STRIP, this.bgnSphere, this.bgnBox - this.bgnSphere);
                        ...
                        // sphere3
            mat4.copy(this.mvpMat, tmp);
            mat4.translate(this.mvpMat, this.mvpMat, vec3.fromValues(-4-0.5, -2.0-0.5, 0.0));
            gl.uniformMatrix4fv(this.u_mvpMatLoc, false, this.mvpMat);
            gl.drawArrays(gl.LINE_STRIP, this.bgnBox, this.bgnTorus - this.bgnBox);
            break;
        
        case 1:
            //-----Sphere 1-----
            mat4.copy(this.mvpMat, tmp);
            mat4.translate(this.mvpMat, this.mvpMat, vec3.fromValues(-2, -3.0, 2.0));
            mat4.scale(this.mvpMat, this.mvpMat, vec3.fromValues(1.0, 1.0, 2.0));
            //mat4.rotate(this.mvpMat, this.mvpMat, 0.3*Math.PI, vec3.fromValues(0,0,1));
            //mat4.rotate(this.mvpMat, this.mvpMat, 0.5*Math.PI, vec3.fromValues(1,0,0));
        
            gl.uniformMatrix4fv(this.u_mvpMatLoc, false, this.mvpMat);
            gl.drawArrays(gl.LINE_STRIP, this.bgnSphere, this.bgnBox - this.bgnSphere);
            //CSG1------------
            mat4.copy(this.mvpMat, tmp);
            mat4.translate(this.mvpMat, this.mvpMat, vec3.fromValues(1.5, -4, 4.0));
            mat4.rotate(this.mvpMat, this.mvpMat, -0.5*Math.PI, vec3.fromValues(1,0,0));
            mat4.rotate(this.mvpMat, this.mvpMat, Math.PI, vec3.fromValues(0,0,1));
            //mat4.rotate(this.mvpMat, this.mvpMat, -0.25*Math.PI, vec3.fromValues(0,0,1));
            //mat4.rotate(this.mvpMat, this.mvpMat, 0.5*Math.PI, vec3.fromValues(1,0,0));
        
            gl.uniformMatrix4fv(this.u_mvpMatLoc, false, this.mvpMat);
            gl.drawArrays(gl.LINE_STRIP, this.bgnSphere+(this.bgnBox - this.bgnSphere)/2, (this.bgnBox - this.bgnSphere)/4);

            mat4.rotate(this.mvpMat, this.mvpMat, -0.5*Math.PI, vec3.fromValues(1,0,0));
            gl.uniformMatrix4fv(this.u_mvpMatLoc, false, this.mvpMat);
            gl.drawArrays(gl.LINE_STRIP, this.bgnSphere, (this.bgnBox - this.bgnSphere)/4);
            mat4.rotate(this.mvpMat, this.mvpMat, 0.5*Math.PI, vec3.fromValues(1,0,0));
            ...
            //CSG2------------
            mat4.copy(this.mvpMat, tmp);
            mat4.translate(this.mvpMat, this.mvpMat, vec3.fromValues(1.5, -4, 1.0));
            mat4.rotate(this.mvpMat, this.mvpMat, -0.5*Math.PI, vec3.fromValues(1,0,0));
            //mat4.rotate(this.mvpMat, this.mvpMat, -0.25*Math.PI, vec3.fromValues(0,0,1));
            //mat4.rotate(this.mvpMat, this.mvpMat, 0.5*Math.PI, vec3.fromValues(1,0,0));
            ...
            mat4.copy(this.mvpMat, tmp);
            mat4.translate(this.mvpMat, this.mvpMat, vec3.fromValues(1.5, -4, 2.5));
            mat4.rotate(this.mvpMat, this.mvpMat, 0.3*Math.PI, vec3.fromValues(1,0,0));

            mat4.scale(this.mvpMat, this.mvpMat, vec3.fromValues(0.9, 0.9, 0.9));
            gl.uniformMatrix4fv(this.u_mvpMatLoc, false, this.mvpMat);
            gl.drawArrays(gl.LINES, this.bgnTorus, this.vboVerts - this.bgnTorus);
            mat4.scale(this.mvpMat, this.mvpMat, vec3.fromValues(10/9, 10/9, 10/9));

            mat4.scale(this.mvpMat, this.mvpMat, vec3.fromValues(1.1, 1.1, 1.1));
            gl.uniformMatrix4fv(this.u_mvpMatLoc, false, this.mvpMat);
            gl.drawArrays(gl.LINES, this.bgnTorus, this.vboVerts - this.bgnTorus);
            mat4.scale(this.mvpMat, this.mvpMat, vec3.fromValues(10/11, 10/11, 10/11));

            mat4.translate(this.mvpMat, this.mvpMat, vec3.fromValues(0.0,0.0,0.1));
            gl.uniformMatrix4fv(this.u_mvpMatLoc, false, this.mvpMat);
            gl.drawArrays(gl.LINES, this.bgnTorus, this.vboVerts - this.bgnTorus);

            mat4.translate(this.mvpMat, this.mvpMat, vec3.fromValues(0.0,0.0,-0.2));
            gl.uniformMatrix4fv(this.u_mvpMatLoc, false, this.mvpMat);
            gl.drawArrays(gl.LINES, this.bgnTorus, this.vboVerts - this.bgnTorus);
            mat4.translate(this.mvpMat, this.mvpMat, vec3.fromValues(0.0,0.0,0.1));
            ...
            mat4.rotate(this.mvpMat, this.mvpMat, 0.5*Math.PI, vec3.fromValues(1,0,0));
            for(i=0;i<50;i++){
                mat4.rotate(this.mvpMat, this.mvpMat, 2*Math.PI/50, vec3.fromValues(0,1,0));
                ...
                mat4.rotate(this.mvpMat, this.mvpMat, 0.5*Math.PI, vec3.fromValues(0,1,0));
                gl.uniformMatrix4fv(this.u_mvpMatLoc, false, this.mvpMat);
                gl.drawArrays(gl.LINES, this.bgnTorus, this.vboVerts - this.bgnTorus);
                mat4.rotate(this.mvpMat, this.mvpMat, -0.5*Math.PI, vec3.fromValues(0,1,0));
                mat4.scale(this.mvpMat, this.mvpMat, vec3.fromValues(10, 10, 10));
                mat4.translate(this.mvpMat, this.mvpMat, vec3.fromValues(0.0,0.0,-1.0));
            }
        ...
        case 2:
            //-----Sphere 1-----
            mat4.copy(this.mvpMat, tmp);
            mat4.rotate(this.mvpMat, this.mvpMat, 2/7*Math.PI, vec3.fromValues(0,0,1));
            ...
            //-----Sphere 2-----
            mat4.copy(this.mvpMat, tmp);mat4.rotate(this.mvpMat, this.mvpMat, 4/7*Math.PI, vec3.fromValues(0,0,1));
            mat4.translate(this.mvpMat, this.mvpMat, vec3.fromValues(0, -4.0, 1.0));
            ...
            //-----Sphere 3-----
            mat4.copy(this.mvpMat, tmp);mat4.rotate(this.mvpMat, this.mvpMat, 6/7*Math.PI, vec3.fromValues(0,0,1));
            mat4.translate(this.mvpMat, this.mvpMat, vec3.fromValues(0, -4.0, 1.0));
            ...
            //-----Sphere 4-----
            mat4.copy(this.mvpMat, tmp);mat4.rotate(this.mvpMat, this.mvpMat, 8/7*Math.PI, vec3.fromValues(0,0,1));
            mat4.translate(this.mvpMat, this.mvpMat, vec3.fromValues(0, -4.0, 1.0));
            ...
            //-----Sphere 5-----
            mat4.copy(this.mvpMat, tmp);mat4.rotate(this.mvpMat, this.mvpMat, 10/7*Math.PI, vec3.fromValues(0,0,1));
            mat4.translate(this.mvpMat, this.mvpMat, vec3.fromValues(0, -4.0, 1.0));
            ...
            //-----Sphere 6-----
            mat4.copy(this.mvpMat, tmp);mat4.rotate(this.mvpMat, this.mvpMat, 12/7*Math.PI, vec3.fromValues(0,0,1));
            mat4.translate(this.mvpMat, this.mvpMat, vec3.fromValues(0, -4.0, 1.0));
            ...
            //-----Sphere 7-----
            mat4.copy(this.mvpMat, tmp);
            mat4.translate(this.mvpMat, this.mvpMat, vec3.fromValues(0-0.5, -4.0-0.5, 1.0));
            //mat4.rotate(this.mvpMat, this.mvpMat, 0.3*Math.PI, vec3.fromValues(0,0,1));
            //mat4.rotate(this.mvpMat, this.mvpMat, 0.5*Math.PI, vec3.fromValues(1,0,0));
        ...
        case 3:
            //-----Box 1-----
            mat4.copy(this.mvpMat, tmp);
            mat4.translate(this.mvpMat, this.mvpMat, vec3.fromValues(-1-0.5, -3-0.5, 3.5));
            //mat4.rotate(this.mvpMat, this.mvpMat, 0.3*Math.PI, vec3.fromValues(0,0,1));
            //mat4.rotate(this.mvpMat, this.mvpMat, 0.5*Math.PI, vec3.fromValues(1,0,0));
            ...
            //-----Box 2-----
            mat4.copy(this.mvpMat, tmp);
            mat4.translate(this.mvpMat, this.mvpMat, vec3.fromValues(0-0.5, -3-0.5, 4-0.5));
            //mat4.rotate(this.mvpMat, this.mvpMat, 0.3*Math.PI, vec3.fromValues(0,0,1));
            //mat4.rotate(this.mvpMat, this.mvpMat, 0.5*Math.PI, vec3.fromValues(1,0,0));
            ...
            //-----Box 3-----
            mat4.copy(this.mvpMat, tmp);
            mat4.translate(this.mvpMat, this.mvpMat, vec3.fromValues(1-0.5, -3-0.5, 4-0.5));
            //mat4.rotate(this.mvpMat, this.mvpMat, 0.3*Math.PI, vec3.fromValues(0,0,1));
            //mat4.rotate(this.mvpMat, this.mvpMat, 0.5*Math.PI, vec3.fromValues(1,0,0));
            ...
            //-----Box 4-----
            mat4.copy(this.mvpMat, tmp);
            mat4.translate(this.mvpMat, this.mvpMat, vec3.fromValues(-1-0.5, -3-0.5, 3-0.5));
            //mat4.rotate(this.mvpMat, this.mvpMat, 0.3*Math.PI, vec3.fromValues(0,0,1));
            //mat4.rotate(this.mvpMat, this.mvpMat, 0.5*Math.PI, vec3.fromValues(1,0,0));
            ...
            gl.drawArrays(gl.LINE_STRIP, this.bgnBox, this.bgnTorus - this.bgnBox);
                        //-----Box 4-----
            mat4.copy(this.mvpMat, tmp);
            mat4.translate(this.mvpMat, this.mvpMat, vec3.fromValues(-1-0.5, -3-0.5, 2-0.5));
            //mat4.rotate(this.mvpMat, this.mvpMat, 0.3*Math.PI, vec3.fromValues(0,0,1));
            //mat4.rotate(this.mvpMat, this.mvpMat, 0.5*Math.PI, vec3.fromValues(1,0,0));
            ...
            gl.drawArrays(gl.LINE_STRIP, this.bgnBox, this.bgnTorus - this.bgnBox);
                        //-----Box 4-----
            mat4.copy(this.mvpMat, tmp);
            mat4.translate(this.mvpMat, this.mvpMat, vec3.fromValues(-1-0.5, -3-0.5, 1-0.5));
            //mat4.rotate(this.mvpMat, this.mvpMat, 0.3*Math.PI, vec3.fromValues(0,0,1));
            //mat4.rotate(this.mvpMat, this.mvpMat, 0.5*Math.PI, vec3.fromValues(1,0,0));
            ...
            gl.drawArrays(gl.LINE_STRIP, this.bgnBox, this.bgnTorus - this.bgnBox);
                                    //-----Box 4-----
            mat4.copy(this.mvpMat, tmp);
            mat4.translate(this.mvpMat, this.mvpMat, vec3.fromValues(0-0.5, -3-0.5, 1-0.5));
            //mat4.rotate(this.mvpMat, this.mvpMat, 0.3*Math.PI, vec3.fromValues(0,0,1));
            //mat4.rotate(this.mvpMat, this.mvpMat, 0.5*Math.PI, vec3.fromValues(1,0,0));
            ...
            //-----Box 1-----
            mat4.copy(this.mvpMat, tmp);
            mat4.translate(this.mvpMat, this.mvpMat, vec3.fromValues(3-0.5, -3-0.5, 4-0.5));
            //mat4.rotate(this.mvpMat, this.mvpMat, 0.3*Math.PI, vec3.fromValues(0,0,1));
            //mat4.rotate(this.mvpMat, this.mvpMat, 0.5*Math.PI, vec3.fromValues(1,0,0));
            ...
            //-----Box 2-----
            mat4.copy(this.mvpMat, tmp);
            mat4.translate(this.mvpMat, this.mvpMat, vec3.fromValues(4-0.5, -3-0.5, 4-0.5));
            //mat4.rotate(this.mvpMat, this.mvpMat, 0.3*Math.PI, vec3.fromValues(0,0,1));
            //mat4.rotate(this.mvpMat, this.mvpMat, 0.5*Math.PI, vec3.fromValues(1,0,0));
            ...
            //-----Box 3-----
            mat4.copy(this.mvpMat, tmp);
            mat4.translate(this.mvpMat, this.mvpMat, vec3.fromValues(5-0.5, -3-0.5, 4-0.5));
            //mat4.rotate(this.mvpMat, this.mvpMat, 0.3*Math.PI, vec3.fromValues(0,0,1));
            //mat4.rotate(this.mvpMat, this.mvpMat, 0.5*Math.PI, vec3.fromValues(1,0,0));
            ...
            //-----Box 4-----
            mat4.copy(this.mvpMat, tmp);
            mat4.translate(this.mvpMat, this.mvpMat, vec3.fromValues(3-0.5, -3-0.5, 3-0.5));
            //mat4.rotate(this.mvpMat, this.mvpMat, 0.3*Math.PI, vec3.fromValues(0,0,1));
            //mat4.rotate(this.mvpMat, this.mvpMat, 0.5*Math.PI, vec3.fromValues(1,0,0));
            ...
            gl.drawArrays(gl.LINE_STRIP, this.bgnBox, this.bgnTorus - this.bgnBox);
                        //-----Box 4-----
            mat4.copy(this.mvpMat, tmp);
            mat4.translate(this.mvpMat, this.mvpMat, vec3.fromValues(3-0.5, -3-0.5, 2-0.5));
            //mat4.rotate(this.mvpMat, this.mvpMat, 0.3*Math.PI, vec3.fromValues(0,0,1));
            //mat4.rotate(this.mvpMat, this.mvpMat, 0.5*Math.PI, vec3.fromValues(1,0,0));
            ...
            gl.drawArrays(gl.LINE_STRIP, this.bgnBox, this.bgnTorus - this.bgnBox);
                        //-----Box 4-----
            mat4.copy(this.mvpMat, tmp);
            mat4.translate(this.mvpMat, this.mvpMat, vec3.fromValues(3-0.5, -3-0.5, 1-0.5));
            //mat4.rotate(this.mvpMat, this.mvpMat, 0.3*Math.PI, vec3.fromValues(0,0,1));
            //mat4.rotate(this.mvpMat, this.mvpMat, 0.5*Math.PI, vec3.fromValues(1,0,0));
            ...
            gl.drawArrays(gl.LINE_STRIP, this.bgnBox, this.bgnTorus - this.bgnBox);
                                    //-----Box 4-----
            mat4.copy(this.mvpMat, tmp);
            mat4.translate(this.mvpMat, this.mvpMat, vec3.fromValues(4-0.5, -3-0.5, 1-0.5));
            //mat4.rotate(this.mvpMat, this.mvpMat, 0.3*Math.PI, vec3.fromValues(0,0,1));
            //mat4.rotate(this.mvpMat, this.mvpMat, 0.5*Math.PI, vec3.fromValues(1,0,0));
            ...
            gl.drawArrays(gl.LINE_STRIP, this.bgnBox, this.bgnTorus - this.bgnBox);
                                    //-----Box 4-----
            mat4.copy(this.mvpMat, tmp);
            mat4.translate(this.mvpMat, this.mvpMat, vec3.fromValues(5-0.5, -3-0.5, 1-0.5));
            //mat4.rotate(this.mvpMat, this.mvpMat, 0.3*Math.PI, vec3.fromValues(0,0,1));
            //mat4.rotate(this.mvpMat, this.mvpMat, 0.5*Math.PI, vec3.fromValues(1,0,0));
            ...
            gl.drawArrays(gl.LINE_STRIP, this.bgnBox, this.bgnTorus - this.bgnBox);
                                                //-----Box 4-----
            mat4.copy(this.mvpMat, tmp);
            mat4.translate(this.mvpMat, this.mvpMat, vec3.fromValues(5-0.5, -3-0.5, 2-0.5));
            //mat4.rotate(this.mvpMat, this.mvpMat, 0.3*Math.PI, vec3.fromValues(0,0,1));
            //mat4.rotate(this.mvpMat, this.mvpMat, 0.5*Math.PI, vec3.fromValues(1,0,0));
...
VBObox0.prototype.appendBox = function() {
    var vertCount = 16;
    var vertSet = new Float32Array ([
        // red X axis:
        0.00, 1.00, 0.0, 1.0,	1.0, 0.0, 0.0, 1.0,
        0.00, 0.00, 0.0, 1.0,	0.0, 1.0, 0.0, 1.0,	
        1.00, 0.00, 0.0, 1.0,	0.0, 0.0, 1.0, 1.0,
        1.00, 1.00, 0.0, 1.0,	1.0, 0.0, 1.0, 1.0,
        0.00, 1.00, 0.0, 1.0,	1.0, 0.0, 0.0, 1.0,
        0.00, 1.00, 1.0, 1.0,	1.0, 1.0, 0.0, 1.0,
        0.00, 0.00, 1.0, 1.0,	0.0, 1.0, 1.0, 1.0,
        0.00, 0.00, 0.0, 1.0,	0.0, 1.0, 0.0, 1.0,
        0.00, 0.00, 1.0, 1.0,	0.0, 1.0, 1.0, 1.0,
        1.00, 0.00, 1.0, 1.0,	1.0, 0.5, 0.0, 1.0,
        1.00, 0.00, 0.0, 1.0,	0.0, 0.0, 1.0, 1.0,
        1.00, 0.00, 1.0, 1.0,	1.0, 0.5, 0.0, 1.0,
        1.00, 1.00, 1.0, 1.0,	0.0, 0.5, 0.5, 1.0,
        1.00, 1.00, 0.0, 1.0,	1.0, 0.0, 1.0, 1.0,
        1.00, 1.00, 1.0, 1.0,	0.0, 0.5, 0.5, 1.0,
        0.00, 1.00, 1.0, 1.0,	1.0, 1.0, 0.0, 1.0
    ]); 
...
VBObox0.prototype.appendTorus = function() {
    var vertCount = 100;
    this.floatsPerVertex = 8;
    var vertSet = new Float32Array (vertCount * this.floatsPerVertex);

    for(i=0; i<50; i++){
        vertSet[i*this.floatsPerVertex*2]=Math.sin(2*Math.PI/50*i);
        vertSet[i*this.floatsPerVertex*2+1]=Math.cos(2*Math.PI/50*i);
        vertSet[i*this.floatsPerVertex*2+2]=0;
        vertSet[i*this.floatsPerVertex*2+3]=1;
        vertSet[i*this.floatsPerVertex*2+4]=i/50;
        vertSet[i*this.floatsPerVertex*2+5]=0;
        vertSet[i*this.floatsPerVertex*2+6]=1-i/50;
        vertSet[i*this.floatsPerVertex*2+7]=1;
        vertSet[i*this.floatsPerVertex*2+8]=Math.sin(2*Math.PI/50*(i+1));
        vertSet[i*this.floatsPerVertex*2+9]=Math.cos(2*Math.PI/50*(i+1));
        vertSet[i*this.floatsPerVertex*2+10]=0;
        vertSet[i*this.floatsPerVertex*2+11]=1;
        vertSet[i*this.floatsPerVertex*2+12]=(i+1)/50;
        vertSet[i*this.floatsPerVertex*2+13]=0;
        vertSet[i*this.floatsPerVertex*2+14]=1-(i+1)/50;
        vertSet[i*this.floatsPerVertex*2+15]=1;
    }
