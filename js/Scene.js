...
CScene.prototype.initScene = function(num) {
    ...
    switch(num) {
        case 0:
            ...
            this.item[iNow].rayRotate(0.25*Math.PI, 1,1,0); // rot 45deg on x axis to face us
            this.item[iNow].matl = new Material(MATL_PEARL);
            ...
            this.item[iNow].matl = new Material(MATL_BRONZE_SHINY);
                        ...
                        //-----Cube 1-----
            this.item.push(new CGeom(RT_BOX));       // Append sphere to item[] &
            iNow = this.item.length -1;                 // get its array index.
            this.item[iNow].setIdent();                   // start in world coord axes
            this.item[iNow].rayTranslate(-4, -2.0, 0.5);  // move rightwards (+x),
            
            this.item[iNow].matl = new Material(MATL_SILVER_DULL);
            break;
        ...
        case 1:
            ...
            iNow = this.item.length -1; 
            this.item[iNow].setIdent();                   // start in world coord axes
            this.item[iNow].rayTranslate(1.5, -4, 2.5);
            ...
            iNow = this.item.length -1;                 // get its array index.
            this.item[iNow].setIdent();                   // start in world coord axes
            this.item[iNow].rayTranslate(-2, -3.0, 2.0);  // move rightwards (+x),
            this.item[iNow].rayScale(1.0,1.0,2.0);  // move rightwards (+x),
            this.item[iNow].matl = new Material(MATL_SILVER_SHINY);
            ...
            iNow = this.item.length -1;                 // get its array index.
            this.item[iNow].setIdent();                   // start in world coord axes
            this.item[iNow].rayTranslate(1.5, -4, 4.0);  // move rightwards (+x),
            ...
            iNow = this.item.length -1;                 // get its array index.
            this.item[iNow].setIdent();                   // start in world coord axes
            this.item[iNow].rayTranslate(1.5, -4, 1.0);  // move rightwards (+x),
        ...
        case 2:
            ...
            iNow = this.item.length -1;                 // get its array index.
            this.item[iNow].setIdent();                   // start in world coord axes
            this.item[iNow].rayRotate(2/7*Math.PI, 0,0,1);
            ...
            iNow = this.item.length -1;                 // get its array index.
            this.item[iNow].setIdent();                   // start in world coord axes
            this.item[iNow].rayRotate(4/7*Math.PI, 0,0,1);
            this.item[iNow].rayTranslate(0, -4.0, 1.0);  // move rightwards (+x),
            ...
            iNow = this.item.length -1;                 // get its array index.
            this.item[iNow].setIdent();                   // start in world coord axes
            this.item[iNow].rayRotate(6/7*Math.PI, 0,0,1);
            this.item[iNow].rayTranslate(0, -4.0, 1.0);  // move rightwards (+x),
            ...
            iNow = this.item.length -1;                 // get its array index.
            this.item[iNow].setIdent();                   // start in world coord axes
            this.item[iNow].rayRotate(8/7*Math.PI, 0,0,1);
            this.item[iNow].rayTranslate(0, -4.0, 1.0);  // move rightwards (+x),
            ...
            iNow = this.item.length -1;                 // get its array index.
            this.item[iNow].setIdent();                   // start in world coord axes
            this.item[iNow].rayRotate(10/7*Math.PI, 0,0,1);
            this.item[iNow].rayTranslate(0, -4.0, 1.0);  // move rightwards (+x),
            this.item[iNow].matl = new Material(MATL_GOLD_SHINY);
            ...
            iNow = this.item.length -1;                 // get its array index.
            this.item[iNow].setIdent();                   // start in world coord axes
            this.item[iNow].rayRotate(12/7*Math.PI, 0,0,1);
            this.item[iNow].rayTranslate(0, -4.0, 1.0);  // move rightwards (+x),
            this.item[iNow].matl = new Material(MATL_BRONZE_SHINY);
        ...
        case 3:
            ...
            iNow = this.item.length - 1;
            this.item[iNow].setIdent();                   // start in world coord axes
            this.item[iNow].rayTranslate(0, -3, 4);
            this.item[iNow].matl = new Material(MATL_PEARL);
            ...
            iNow = this.item.length - 1;
            this.item[iNow].setIdent();                   // start in world coord axes
            this.item[iNow].rayTranslate(-1, -3, 3);
            this.item[iNow].matl = new Material(MATL_PEARL);
            ...
            iNow = this.item.length - 1;
            this.item[iNow].setIdent();                   // start in world coord axes
            this.item[iNow].rayTranslate(-1, -3, 1);
            this.item[iNow].matl = new Material(MATL_PEARL);
            ...
            iNow = this.item.length - 1;
            this.item[iNow].setIdent();                   // start in world coord axes
            this.item[iNow].rayTranslate(3, -3, 4);
            this.item[iNow].matl = new Material(MATL_RUBY);

            //---Box----
            this.item.push(new CGeom(RT_BOX));
            iNow = this.item.length - 1;
            this.item[iNow].setIdent();                   // start in world coord axes
            this.item[iNow].rayTranslate(4, -3, 4);
            this.item[iNow].matl = new Material(MATL_RUBY);
            ...
            iNow = this.item.length - 1;
            this.item[iNow].setIdent();                   // start in world coord axes
            this.item[iNow].rayTranslate(5, -3, 4);
            this.item[iNow].matl = new Material(MATL_RUBY);
            ...
            iNow = this.item.length - 1;
            this.item[iNow].setIdent();                   // start in world coord axes
            this.item[iNow].rayTranslate(3, -3, 3);
            this.item[iNow].matl = new Material(MATL_RUBY);
            ...
            iNow = this.item.length - 1;
            this.item[iNow].setIdent();                   // start in world coord axes
            this.item[iNow].rayTranslate(3, -3, 2);
            this.item[iNow].matl = new Material(MATL_RUBY);
            ...
            iNow = this.item.length - 1;
            this.item[iNow].setIdent();                   // start in world coord axes
            this.item[iNow].rayTranslate(4, -3, 1);
            this.item[iNow].matl = new Material(MATL_RUBY);
            ...
            iNow = this.item.length - 1;
            this.item[iNow].setIdent();                   // start in world coord axes
            this.item[iNow].rayTranslate(5, -3, 1);
            this.item[iNow].matl = new Material(MATL_RUBY);
            ...
            iNow = this.item.length - 1;
            this.item[iNow].setIdent();                   // start in world coord axes
            this.item[iNow].rayTranslate(5, -3, 2);
            this.item[iNow].matl = new Material(MATL_RUBY);
            break;
        default:
